...
- [x] **Livrable 1 fermé (2026-09-22).** Migration confirmée sur S37-S39 (démarrée le 12 septembre, dans S37 — cohérent avec « des choses se sont passées avant et après » ; seuil de détection non ajusté, il avait raison). Chiffre final, vérifié dans le rapport régénéré (196 billets) : déficit cumulé brut +98, **déficit cumulé hors S37/S38/S39 = +0**. Hors migration, le rythme créés/fermés de One Portail est équilibré — bon chiffre à présenter tel quel.
