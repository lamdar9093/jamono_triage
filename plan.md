...
- [ ] **Anomalie ouverte : semaine 2026-S38.** 134 des 195 billets (69 % du corpus) créés cette seule semaine, contre 35-70/semaine ailleurs. L'amas de doublons suspectés (56 paires) tombe dans les mêmes plages de tickets. Persiste même dans le périmètre restreint (label), donc ce n'est pas un artefact de notre filtre — quelque chose de réel s'est produit. **Nécessite que l'utilisateur regarde ces billets et dise ce qui s'est passé** (campagne, bug, migration ?) avant de présenter le rapport à la gestionnaire.
- [ ] Rapport présentable en fin de semaine (livrable 1), sans IA — bloqué sur l'explication du pic S38 ci-dessus.
